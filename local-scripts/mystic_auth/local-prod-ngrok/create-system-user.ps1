...
# stack (docker/mystic_auth/compose/docker-compose.local-prod-ngrok.yml). Fill in
# local-scripts/local-prod-ngrok/system-user.env first. Assumes a fresh account (no
...
# `docker compose -f docker/mystic_auth/compose/docker-compose.local-prod-ngrok.yml -f docker/app/compose/docker-compose.local-prod-ngrok.yml --env-file env/mystic_auth/.env.local-prod-ngrok --env-file env/app/.env.local-prod-ngrok exec backend python -m mystic_auth.scripts.create_system_user`
...
try {
    ...
    cmd /c "docker compose -f docker/mystic_auth/compose/docker-compose.local-prod-ngrok.yml -f docker/app/compose/docker-compose.local-prod-ngrok.yml --env-file env/mystic_auth/.env.local-prod-ngrok --env-file env/app/.env.local-prod-ngrok exec -T backend python -m mystic_auth.scripts.create_system_user < ""$tempFile"""
} finally {
