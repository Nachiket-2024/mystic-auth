# tests/backend/mystic_auth/unit/test_user_email_crud_unit.py
#
...
from backend.mystic_auth.user.user_crud_modules.user_email_crud import (
    UserEmailCRUD,
)
...
EMAIL_CRUD_MODULE = "backend.mystic_auth.user.user_crud_modules.user_email_crud"
BASE_CRUD_MODULE = "backend.mystic_auth.user.user_crud_modules.user_base_crud"
