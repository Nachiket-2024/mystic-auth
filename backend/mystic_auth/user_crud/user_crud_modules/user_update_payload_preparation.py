...
async def prepare_update_data(update_data: UserUpdate) -> dict:
    ...
    user_management_update_routes.py (update_any_user): both routes accept the
    same UserUpdate body and need this same password-strength-check-then-hash
    step before it ever reaches user_crud.update.
    """
