...
Codex was used for the first time on Jul 28, 2026, mainly because I hit my weekly limit on Claude Code 😅. Its role was closest to the Claude Code loop above: read the existing codebase, compare docs against the current implementation, apply focused cleanup, and report what changed without rewriting the architecture.