...
JWT_ISSUER=https://<your-app>.ngrok-free.app
...
- `BACKEND_BASE_URL` must be *set* for the app to boot, but nothing reads it at runtime, so it can stay the same value.
