...
|---|---|---|---|
| Soft delete (admin) | `DELETE /users/{email}` | `users:deactivate_any` | Yes, via reactivate |
...
| Purge (hard delete, manual) | `DELETE /users/{email}/purge` | `users:delete_any` | **No** |
