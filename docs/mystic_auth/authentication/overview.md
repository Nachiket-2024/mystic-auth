...
- [Session Management](session-management.md): active-session tracking, refresh-token rotation mirror, real-time revocation push
- [Account Deletion and Purge](account-deletion.md)

For *authorization* (what an authenticated caller is allowed to do, once identified), see
