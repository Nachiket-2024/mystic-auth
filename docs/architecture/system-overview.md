...
4. On a 401 specifically, `frontend/src/auth/setupAuthInterceptor.ts` attempts one silent refresh-and-retry before giving up and marking the session invalid — see [Authentication Flows](../authentication/overview.md#refresh-token-rotation).
