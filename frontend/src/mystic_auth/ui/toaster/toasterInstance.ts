...
/**
 * App-wide toast queue singleton. Call `toaster.create({...})` from any
 * component/hook to surface a success/error/info message.
 *
 * Split into its own file (rather than toaster.tsx alongside the <Toaster />
