        ...
        <InputGroup
            endElement={
                <IconButton
                    ...
                    // same issue ICON_BUTTON_PROPS fixes for navbar icon
                    // buttons. Muted at rest so it doesn't outcompete the
                    // input's text, then a soft tint + full-contrast icon on
                    // hover so it "lights up" as clickable - lighter than
                    // ICON_BUTTON_PROPS's solid fill since this lives inside
                    // an input rather than a standalone toolbar.
                    color="fg.muted"
